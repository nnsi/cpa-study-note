        ...
        {data?.subjects.map((subject, index) => (
          ...
          >
            <div className="relative flex items-start gap-4">
              {/* アイコン */}
              <div className={`size-12 rounded-xl ${getSubjectColor(subject.name)} flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform duration-300`}>
...
function getSubjectColor(name: string): string {
  ...
  return colorMap[name] || "bg-ink-100"
}
