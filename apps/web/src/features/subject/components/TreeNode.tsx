...
import type { CategoryNodeInput, TopicNodeInput } from "../api"
    ...
    <div className="card overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-transparent px-4 py-3 border-b border-ink-100">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-ink-400">({category.topics.length})</span>
            ...
            <div className="space-y-1">
              {category.topics.map((topic, topicIdx) => (
                <TopicNode
                  ...
                  isSelected={selectedTopicId === String(topicIdx)}
