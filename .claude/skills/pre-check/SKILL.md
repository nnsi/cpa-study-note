...
```
例: 「5クリック問題」への対応
- 回避策: 検索機能、ブックマーク機能を追加
- 本質的解決: メインの導線（科目一覧のUI）を改善

→ 追加機能でカバーするより、メインの導線を改善する方が効果的なことが多い
```

### ユーザーのメンタルモデルを考える

```
例: 「学習タブで編集機能を追加」という提案
- 考慮すべき: 「学習タブ」をクリックする人は学習したい、編集したいわけではない
- 本質的解決: 学習と編集を分離する
...
- [ ] 追加機能で問題を回避しようとしていないか確認した
- [ ] ユーザーのメンタルモデルに合った設計か確認した
